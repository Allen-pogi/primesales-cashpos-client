...
const bankColors = ["bg-red-500", "bg-blue-600", "bg-green-500", "bg-cyan-500"];

const role = "assistant";

const AssistantCashPositionReportPage = () => {
  ...
  const handleExportToExcel = async () => {
    ...
    // ==== Title Row ====
    worksheet.addRow([`Assistant Cash Position Report - ${reportDate}`]);
    ...
    a.href = url;
    a.download = `Assistant_Cash_Report_${reportDate}.xlsx`;
    a.click();
    ...
    >
      ...
      {reportDate && (
        <>
          ...
          <table className="w-full table-auto border  border border-gray-700 mb-10 text-sm">
...
export default AssistantCashPositionReportPage;
