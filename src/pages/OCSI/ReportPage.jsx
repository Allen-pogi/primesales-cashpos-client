...
//   { label: "BPI", code: "1234", logoUrl: "/bpi.webp" },
// ];
...
const OCSICashPositionReportPage = () => {
  ...
  const handleExportToExcel = async () => {
    ...
    // ==== Title Row ====
    worksheet.addRow([`Admin OCSI Cash Position Report - ${reportDate}`]);
    ...
    a.href = url;
    a.download = `OCSI_Cash_Report_${reportDate}.xlsx`;
    a.click();
...
export default OCSICashPositionReportPage;
